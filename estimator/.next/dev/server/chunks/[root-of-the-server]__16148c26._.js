...
async function POST(request) {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: "subscription",
            success_url: `${("TURBOPACK compile-time value", "http://localhost:3001")}/settings?session_id={CHECKOUT_SESSION_ID}&success=true`,
            cancel_url: `${("TURBOPACK compile-time value", "http://localhost:3001")}/settings`,
            metadata: {
                user_id: user.id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16148c26._.js.map